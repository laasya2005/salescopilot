    ...
    <div className="mt-2 p-2.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
      <div className="flex items-start gap-2">
        ...
        <div className="text-xs space-y-0.5 min-w-0">
          <p className="text-emerald-300 font-medium">{task.task}</p>
          <div className="flex flex-wrap gap-x-3 gap-y-0.5 text-slate-400">
            ...
            <span>Deadline: <span className="text-slate-300">{task.deadline}</span></span>
            <span>Source: <span className="text-slate-300">{task.source}</span></span>
          </div>
        </div>
      </div>
    </div>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800 shrink-0 bg-slate-950">
          ...
          <button
            ...
            className="text-slate-500 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 rounded p-1"
          >
